          ...
          child: Center(
            child: Column(
              children: [
                ...
                SizedBox(height: 4.h,),
                Text(AppString.refundre,style: CustomStyles.textStyle(fontSize: 14.sp,fontColor: CustomColors.textcolor2,fontWeight: FontWeight.w900,letterspacing: 0.2),),
                SizedBox(height: 1.h,),
                Text(AppString.ticketche,style: CustomStyles.textStyle(fontSize: 10.sp,fontColor: CustomColors.textcolor5,fontWeight: FontWeight.normal,letterspacing: 0.2),),
                Text(AppString.button,style: CustomStyles.textStyle(fontSize: 10.sp,fontColor: CustomColors.textcolor5,fontWeight: FontWeight.normal,letterspacing: 0.2),),
